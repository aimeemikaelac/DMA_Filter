...
@str = internal constant [11 x i8] c"dma_filter\00"
...
_ifconv:
  ...
  %minAddress_read = call i32 @_ssdm_op_Read.ap_auto.i32(i32 %minAddress)
  %minAddress_assign = alloca i32, align 4
  store volatile i32 %minAddress_read, i32* %minAddress_assign, align 4
  call void (...)* @_ssdm_op_SpecWire(i1 %reset, [8 x i8]* @p_str, i32 0, i32 0, i32 0, i32 1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
  call void (...)* @_ssdm_op_SpecWire(i32 %minAddress, [10 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
